                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <a class="font-heading font-bold text-teal-700"
                            ...
                            <div class="bg-white rounded-2xl border p-5 space-y-5">
                                <div>
                                    ...
                                    <div class="relative w-full overflow-hidden rounded-full bg-teal-100 h-2 mb-2">
                                        <div id="progressBar" class="h-full bg-teal-500 transition-all duration-300"
                                            style="width: 0%"></div>
                                    </div>
                                    <p class="text-xs text-gray-500"><span id="answeredCount">0</span> of
                                        {{ $totalQuestions }} answered</p>
                                </div>
                                <div class="space-y-3">
                                    <button
                                        class="flex w-full items-center justify-between rounded-md border border-gray-200 px-3 py-2 text-xs h-9 bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-5 gap-1.5" id="questionNav">
                                        @foreach ($questions as $q)
                                            <button
                                                class="question-btn w-9 h-9 rounded-full text-xs font-semibold transition-all relative bg-gray-100 text-gray-600 hover:bg-gray-200"
                        ...
                        <div class="space-y-5" id="questionContainer">
                            @foreach ($questions as $index => $question)
                                <div class="question-slide {{ $index === 0 ? 'active' : 'hidden' }}"
                                    ...
                                    <div class="bg-white rounded-2xl border p-6">
                                        <div class="flex items-center justify-between mb-3">
                                            <div class="flex items-center gap-2 flex-wrap">
                                                <div
                                                    class="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold bg-teal-100 text-teal-700">
                                                    {{ $exam->school->name }}</div>
                                                <div
                                                    class="inline-flex items-center rounded-md border px-2.5 py-0.5 font-semibold text-gray-700 text-xs">
                                                    {{ $question->question_type }}</div>
                                                <div
                                                    class="inline-flex items-center rounded-md border px-2.5 py-0.5 font-semibold text-gray-700 text-xs">
                                                    Easy</div>
                                            </div>
                                        ...
                                        <p class="font-medium text-gray-900 leading-relaxed">{{ $question->question }}
                                        </p>
                                    </div>
                                        ...
                                        @foreach ($question->choices as $choice)
                                            ...
                                            <div class="bg-white border rounded-xl p-4 cursor-pointer transition-all text-sm hover:border-gray-400/30 hover:shadow-sm answer-option"
                                                ...
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div
                                                        style="width:28px;height:28px;border-radius:50%;background:#14b8a6;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                                        <span
                                                            style="color:#ffffff;font-size:12px;font-weight:700;line-height:1;">{{ $letter }}</span>
                                                    </div>
                                                    <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <button
                                            class="inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium h-9 px-4 py-2 flex-1 bg-gradient-to-r from-teal-400 to-teal-600 text-white shadow-lg disabled:opacity-50 check-answer-btn">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <button
                                            class="inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium h-9 px-4 py-2 border border-gray-200 hover:bg-gray-50 skip-btn">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2">
                                        ...
                                        <button
                                            class="inline-flex items-center justify-center rounded-md text-sm font-medium h-9 w-9 border border-gray-200 hover:bg-gray-50 flag-btn"
                                            title="Flag question">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2">
                                    ...
                                    <div class="rationale-section space-y-4 hidden">
                                        <div
                                            class="rounded-xl p-4 bg-red-50 border border-red-200 incorrect-message hidden">
                                            <div class="flex items-center gap-2 mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" class="text-red-600">
                                                    <circle cx="12" cy="12" r="10" />
                                                    <path d="m15 9-6 6" />
                                                    <path d="m9 9 6 6" />
                                                </svg>
                                                <span class="font-heading font-bold text-red-700">Incorrect — but
                                                    you're
                                                    learning! 📚</span>
                                            </div>
                                        </div>
                                        <div
                                            class="rounded-xl p-4 bg-green-50 border border-green-200 correct-message hidden">
                                            <div class="flex items-center gap-2 mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <span class="font-heading font-bold text-green-700">Correct! Well done!
                                                    🎉</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-amber-50 rounded-xl border border-amber-200 p-5">
                                            <h4 class="font-heading font-bold text-sm mb-2 flex items-center gap-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" class="text-amber-600">
                                                    <path
                                    ...
                                    <button
                                        class="inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium h-9 px-4 py-2 flex-1 bg-gradient-to-r from-teal-400 to-teal-600 text-white shadow-lg next-question-btn hidden">
                                        Next Question
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="bg-white rounded-2xl border p-5">
                                    <h3 class="font-heading font-bold text-sm mb-4 flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" class="text-teal-500">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <div class="flex justify-between text-xs mb-1">
                                                ...
                                                <span class="font-semibold"><span
                                                        id="progressAnswered">0</span>/{{ $totalQuestions }}</span>
                                            </div>
                                        ...
                                        <div>
                                            <div class="flex justify-between text-xs mb-1">
                                                ...
                                                <span class="font-semibold"><span
                                                        id="accuracyPercent">0</span>%</span>
                                            </div>
                                            <div class="relative w-full overflow-hidden rounded-full bg-teal-100 h-2">
                                                <div id="accuracyBar"
                                                    class="h-full bg-teal-500 transition-all duration-300"
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        @foreach ($sections as $section)
                                            @if (count($section->topics) > 0)
                                                <a href="{{ route('study-notes.content', ['school' => request('schoolSlug'), 'section' => $section->slug, 'topic' => $section->topics[0]->slug]) }}"
                                                    class="block w-full text-left p-2.5 rounded-lg bg-gray-50 text-xs font-medium hover:bg-teal-50 hover:text-teal-700 flex items-center justify-between">
