                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <a class="font-heading font-bold text-teal-700"
                                href="{{ route('certification.show', $exam->school->slug) }}">{{
                                $exam->name }}</a>
                        </div>
                                    ...
                                    <div class="bg-white border rounded-xl p-4 cursor-pointer transition-all text-sm hover:border-gray-400/30 hover:shadow-sm answer-option"
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div
                                                ...
                                                <span
                                                    style="color:#ffffff;font-size:12px;font-weight:700;line-height:1;">{{
                                                    $letter }}</span>
                                            </div>
                                            <div class="flex-1">
                                ...
                                <div class="rationale-section space-y-4 hidden">
                                    <div
                                        ...
                                        <div class="flex items-center gap-2 mb-2">
                                            ...
                                            <span class="font-heading font-bold text-red-700">Incorrect — but you're
                                                learning! 📚</span>
                                        </div>
                                    </div>
                                    <div
                                    ...
                                    <div class="bg-amber-50 rounded-xl border border-amber-200 p-5">
                                        ...
                                        <p class="text-sm text-amber-800 leading-relaxed">{{ $question->wrong_answer ??
                                            'Review this question carefully.' }}</p>
                                    </div>
                            ...
                            <div class="space-y-5">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <div class="flex justify-between text-xs mb-1">
                                                ...
                                                <span class="font-semibold"><span id="progressAnswered">0</span>/{{
                                                    $totalQuestions }}</span>
                                            </div>
                                ...
                                <div class="bg-gradient-to-br from-teal-500 to-blue-600 rounded-2xl p-5 text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" class="text-yellow-300 mb-3">
                                        <path
                                    ...
                                    <p class="text-xs text-white/80 mb-4">Unlock unlimited questions, video lessons, and
                                        exam simulations.</p>
                                    <a href="/pricing">
                                        <button
                                ...
                                <div class="bg-white rounded-2xl border p-5">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <a href="{{ $note->url ?? '/notes/' . Str::slug($note->title) }}"
                                        ...
                                        <a href="/notes/infection-control"
                                            class="block w-full text-left p-2.5 rounded-lg bg-gray-50 text-xs font-medium hover:bg-teal-50 hover:text-teal-700 flex items-center justify-between">
