...
<body>
    <div id="root">
        <div class="min-h-screen flex flex-col">
            ...
            <main class="flex-1">
                <div>
                    <section class="py-16 lg:py-20 {{ $certification['colors']['bg_light'] }} relative overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-r from-white/60 to-transparent"></div>
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                            <div class="grid lg:grid-cols-2 gap-10 items-center">
                                <div>
                                    <div
                                        class="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent shadow hover:bg-primary/80 {{ $certification['colors']['badge_bg'] }} {{ $certification['colors']['badge_text'] }} mb-4">
                                        {{ $certification['badge'] }}</div>
                                    <h1 class="font-heading text-4xl sm:text-5xl font-bold text-foreground mb-3">{{
                                        $certification['title_abbr'] }} <span class="{{ $certification['colors']['badge_text'] }}">Exam
                                            Prep</span></h1>
                                    <p class="text-lg text-muted-foreground mb-3">{{ $certification['title_full'] }}</p>
                                    <p class="text-muted-foreground leading-relaxed mb-8">{{ $certification['description'] }}</p>
                                    ...
                                    <div class="flex flex-wrap gap-4 mb-8">
                                        <div class="flex items-center gap-2 text-sm"><svg
                                            ...
                                            </svg>{{ $certification['stats']['questions'] }} Questions</div>
                                        <div class="flex items-center gap-2 text-sm"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        <a
                                            ...
                                            <button
                                                class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors hover:bg-primary/90 h-10 rounded-md px-8 bg-gradient-to-r {{ $certification['colors']['gradient'] }} text-white shadow-lg">Start
                                ...
                                <div class="flex justify-center">
                                    <div
                                        class="w-64 h-64 rounded-3xl bg-gradient-to-br {{ $certification['colors']['gradient'] }} flex items-center justify-center shadow-2xl">
                                        <div class="text-center text-white">
                                            <div class="text-6xl font-heading font-bold mb-2">{{ $certification['title_abbr'] }}
                                            </div>
                            ...
                            <div class="grid lg:grid-cols-[1fr_300px] gap-10 items-start">
                                <div>
                                    <span
                                        ...
                                        Format</span>
                                    <h2 class="font-heading text-2xl sm:text-3xl font-bold mb-8">{{ $certification['title_abbr']
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-sm text-foreground">{{
                                                    $certification['stats']['total_exam_q'] }}</p>
                                            </div>
                                        </div>
                                        <div
                                            class="flex items-center gap-4 p-4 rounded-xl border bg-slate-50/60 hover:shadow-sm transition-shadow">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-sm text-foreground">{{
                                                    $certification['stats']['duration'] }}</p>
                                            </div>
                                        </div>
                                        <div
                                            class="flex items-center gap-4 p-4 rounded-xl border bg-slate-50/60 hover:shadow-sm transition-shadow">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-sm text-foreground">{{
                                                    $certification['stats']['passing_score'] }}</p>
                                            </div>
                                        </div>
                                        <div
                                            class="flex items-center gap-4 p-4 rounded-xl border bg-slate-50/60 hover:shadow-sm transition-shadow">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-sm text-foreground">{{
                                                    $certification['stats']['provider'] }}</p>
                                            </div>
                                        </div>
                                        <div
                                            class="flex items-center gap-4 p-4 rounded-xl border bg-slate-50/60 hover:shadow-sm transition-shadow">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-sm text-foreground">{{
                                                    $certification['stats']['difficulty'] }}</p>
                                            </div>
                                        </div>
                                        <div
                                            class="flex items-center gap-4 p-4 rounded-xl border bg-slate-50/60 hover:shadow-sm transition-shadow">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-sm text-foreground">{{
                                                    $certification['stats']['failure_rate'] }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <span
                                                class="px-3 py-1.5 rounded-full text-xs font-semibold text-white bg-gradient-to-r {{ $certification['colors']['gradient'] }}">{{
                                                $category }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex justify-between items-start pb-4 border-b">
                                            <div>
                                                ...
                                                <p class="text-xs text-muted-foreground">Range: {{
                                                    $certification['stats']['salary_range'] }}</p>
                                            </div>
                                            <span class="font-bold text-sm {{ $certification['colors']['badge_text'] }}">{{
                                                $certification['stats']['salary_avg'] }}</span>
                                        </div>
                                        <div class="flex justify-between items-center pb-4 border-b">
                                            <p class="text-sm text-muted-foreground">Job Growth</p><span
                                                class="font-bold text-sm">{{ $certification['stats']['job_growth'] }}</span>
                                        </div>
                                        <div class="flex justify-between items-center pb-4 border-b">
                                            <p class="text-sm text-muted-foreground">Study Duration</p><span
                                                class="font-bold text-sm">{{ $certification['stats']['study_duration'] }}</span>
                                        </div>
                                        <div class="flex justify-between items-center pb-4 border-b">
                                            <p class="text-sm text-muted-foreground">Our Question Bank</p><span
                                                class="font-bold text-sm">{{ $certification['stats']['bank_size'] }}</span>
                                        </div>
                                        <div class="flex justify-between items-center">
                                            <p class="text-sm text-muted-foreground">Free Questions</p><span
                                                class="font-bold text-sm text-amber-600">{{ $certification['stats']['free_q']
                                                }}</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section class="py-16 bg-muted/30">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
                                ...
                                <div
                                    class="p-4 rounded-xl border {{ $certification['colors']['border_light'] }} {{ $certification['colors']['bg_light'] }} flex items-center gap-3 hover:shadow-md transition-shadow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="lucide lucide-circle-check-big w-5 h-5 {{ $certification['colors']['badge_text'] }} flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex items-start gap-3">
                                            <div
                                                class="w-8 h-8 rounded-lg bg-gradient-to-br {{ $certification['colors']['gradient'] }} flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <section class="py-16 bg-gradient-to-r {{ $certification['colors']['gradient'] }}">
                        <div class="max-w-3xl mx-auto px-4 text-center">
                            ...
                            <h2 class="font-heading text-3xl font-bold text-white mb-4">Start Your {{ $certification['title_abbr'] }} Prep Today</h2>
                            <p class="text-white/80 mb-8">Get unlimited access to {{ $certification['stats']['questions'] }}
                    ...
                    <section class="py-16 bg-background">
                        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="text-center mb-10">
                                <h2 class="font-heading text-3xl font-bold">{{ $certification['title_abbr'] }} Prep FAQ</h2>
                            </div>
                            <div class="faq-accordion-group">
                                <div class="faq-item">
                                    <button class="faq-trigger" onclick="window.toggleFaq(this)">How many questions are
                                        in the {{ $certification['title_abbr'] }} question bank?<svg
                                    ...
                                    <div class="faq-panel">
                                        <div class="faq-content">We have a comprehensive bank of {{
                                            $certification['stats']['questions'] }} questions directly mirroring the real exam.
                                        </div>
                                    </div>
                                </div>
                                <div class="faq-item">
                    ...
                    @include('partials.related-certs', ['current' => $certification['id']])
            ...
            <div class="fixed bottom-4 right-4 z-50 max-w-xs">
                <div
                    class="bg-gradient-to-br {{ $certification['colors']['gradient'] }} rounded-2xl p-5 shadow-2xl text-white relative">
                    ...
                    <p class="text-sm text-white/90 mb-3">Try {{ $certification['stats']['free_q'] }} and see how you score.</p>
                    <a
                        href="{{ route('questions.index', ['schoolSlug' => $certification['school_slug'], 'examSlug' => $certification['id']]) }}">
                        <button
                            class="inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors h-8 rounded-md px-3 text-xs w-full bg-white {{ $certification['colors']['badge_text'] }} hover:bg-white/90 font-semibold shadow-md">Start
                            Free Quiz →</button>
                    </a>
                </div>
            </div>
