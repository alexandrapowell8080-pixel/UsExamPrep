            ...
            <div class="footer-brand-column">
                <a class="footer-logo-link" href="/">
                    <div class="logo-icon-wrapper">
                        <img src="{{ asset('images/logo.png') }}" alt="UsExamPrep Logo" class="footer-logo-image">
                    </div>

                    <span class="logo-text text-white">
                        Us<span class="text-teal">Exam</span>Prep
                    </span>
                </a>
                ...
                <div class="footer-contacts">
                    <a href="mailto:support@usexamprep.com" class="contact-link-row">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="contact-svg">
