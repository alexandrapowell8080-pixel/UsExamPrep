<x-study-notes>
    ...
    @section('canonical', config('app.url') . '/study-notes/' .$school->slug.'/'.$section->slug.'/'. $topic->slug)

    <div class="min-h-screen   px-4 md:px-8 comic-neue-regular flex sm:flex-row flex-col-reverse">
        <!-- Added an ID 'sidebar-accordion' to the parent -->
   ...
   {{ request()->routeIs('study-notes.content') && request()->segment(4) === $topic->slug
       ...
       : 'text-gray-600 hover:text-indigo-600 hover:bg-indigo-50' }}">
        ...
        <div class="sm:w-10/12 mx-10/12 mx-auto pt-5 max-h-screen overflow-scroll hide-scrollbar">
