...
<head>
    ...
    <meta
        content="https://media.base44.com/images/public/69fdcb5440d32f0540edfdf6/39aa2e136_logo.png/v1/fill/w_1200,h_630/39aa2e136_logo.png"
        property="og:image">
    <meta content="https://us-exam-prep-copy-a8b63635.base44.app" property="og:url">
    ...
    <meta content="https://us-exam-prep-copy-a8b63635.base44.app" name="twitter:url">

    <meta content="yes" name="mobile-web-app-capable">
    <meta content="black" name="apple-mobile-web-app-status-bar-style">
    <meta content="UsExamPrep" name="apple-mobile-web-app-title">
    <link href="https://us-exam-prep-copy-a8b63635.base44.app" rel="canonical">
    ...
    <script type="application/ld+json">
        ...
        "@@type": "WebSite",
        "name": "UsExamPrep",
        "url": "https://us-exam-prep-copy-a8b63635.base44.app"
    }
    </script>
    <script type="application/ld+json">
        {
        ...
        "@@type": "Organization",
        "name": "UsExamPrep",
        "logo": "https://media.base44.com/images/public/69fdcb5440d32f0540edfdf6/39aa2e136_logo.png",
        "url": "https://us-exam-prep-copy-a8b63635.base44.app"
    }
    </script>
</head>
...
<body>
            ...
            <a class="nav-logo-group" href="/">
                <div class="logo-icon-wrapper">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="cap-svg">
                        <path
                ...
                <span class="logo-text">Us<span class="brand-accent">Exam</span>Prep</span>
            </a>

            <div class="nav-links-desktop">
                <a class="nav-link active" href="/">Home</a>
                <button class="nav-dropdown-btn" type="button" id="certifications-menu-btn">
                    Certifications
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <main class="page-main">
        ...
        <section class="hero-section">
            ...
            <div class="hero-container max-width-wrapper">
                ...
                <h1 class="hero-headline animated fadeInUp delay-2">The #1 Medical Study Hub</h1>
                ...
                <h2 class="hero-dynamic-headline animated fadeInUp delay-3">
                    ...
                    <span class="headline-sliding-wrapper" id="dynamic-wrapper">
                        <span class="dynamic-rotating-text active is-in">Nursing Students</span>
                        <span class="dynamic-rotating-text">Medical Assistants</span>
                        <span class="dynamic-rotating-text">Pharmacy Techs</span>
                    </span>
                </h2>
                ...
                <div class="hero-cta-area animated fadeInUp delay-5">
                    ...
                    <div class="hero-cta-group">
                        <a class="hero-cta-btn btn-secondary-gray" href="/certifications">
                            <span class="btn-inner-content">
                                ...
                                <span class="btn-label-text">Explore Certifications</span>
                            </span>
                        </a>

                        <a class="hero-cta-btn btn-primary-blue" href="/certifications">
                            <span class="btn-inner-content">
                                <span class="btn-icon">
                                ...
                                <span class="btn-label-text">Start Practicing Free</span>
                            </span>
                        </a>
                    </div>
    ...
    <footer class="page-footer">
        <div class="max-width-wrapper footer-main-content">
            <div class="footer-primary-grid">
                <div class="footer-brand-column">
                    <a class="footer-logo-link" href="/">
                        ...
                        <span class="logo-text text-white">Us<span class="text-teal">Exam</span>Prep</span>
                    </a>
                    ...
                    <div class="footer-contacts">
                        <a href="mailto:support@usexamprep.com" class="contact-link-row">
                            ...
                            support@usexamprep.com
                        </a>
                        <a href="tel:+18006373773" class="contact-link-row">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="contact-svg">
                                <path
            ...
            <div class="footer-links-row-grid">
                <div>
        ...
        <div class="footer-copyright-bar">
            <div class="max-width-wrapper copyright-inner">
                ...
                <p class="love-notice">
                    Made with
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="heart-mini-svg">
                        <path
    ...
    <script>
        function toggleFaq(button) {
            ...
            // Close all first for clean accordion effect
