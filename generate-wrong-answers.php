...
function generateWrongAnswerContent($questionData, $apiKey, $apiUrl)
{
    ...
    $systemPrompt = 'You are an expert educational psychologist and test-prep specialist. Write a single, cohesive paragraph (approximately 100 words) explaining why learners frequently select incorrect options for the provided question. Analyze the question stem, all answer choices, the correct answer, and the official rationale. Identify the specific misconceptions, semantic overlaps, or logical traps that make distractors seem plausible. Clearly articulate the precise conceptual distinction between the correct answer and the strongest distractors, embedding exact definitions or quick-decision rules directly into the explanation. Highlight specific keywords or contextual cues in the question that should trigger the correct choice under exam conditions. Maintain a supportive, instructional tone focused on building practical, exam-ready critical thinking. Do not use bullet points or lists. Never use the phrase “students also get this wrong” or similar variations. Deliver only the paragraph, ensuring every sentence directly clarifies the reasoning behind common errors and provides immediately applicable test-taking guidance.';


    $userPrompt = "Question: {$questionData['question']}\n\nAvailable Choices:\n{$choicesStr}\n\nCorrect Answer: {$questionData['correct_answer']}\n\nOfficial Rationale: {$questionData['rationale']}\n\nGenerate the 'Students Also Get This Wrong' paragraph now, focusing on why learners commonly select the wrong options despite knowing the rationale.";
