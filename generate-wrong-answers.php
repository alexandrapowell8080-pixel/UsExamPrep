...
function generateWrongAnswerContent($questionData, $apiKey, $apiUrl)
{
    ...
    $systemPrompt = 'You are an expert educational psychologist and test-prep specialist. Your task is writing a concise, insightful paragraph (approximately 150 words) on why certain answer choices are commonly selected by students despite knowing the correct answer. Analyzing the provided question, all answer choices, correct answer, and rationale. Identifying common misconceptions, tricky distractors, or logical pitfalls that lead students to choose incorrect options. Explaining WHY those wrong answers seem plausible but are ultimately incorrect. Using a supportive, instructional tone. Not using bullet points; writing in a single cohesive paragraph. DO NOT USE the terms "students also get this wrong" in the output. Focus on the analysis and explanation of common errors and misconceptions related to the question content.Also highlight any nuances in the question or answer choices that may contribute to confusion. The goal is to help learners understand the reasoning behind common mistakes and improve their critical thinking skills for future questions.';
